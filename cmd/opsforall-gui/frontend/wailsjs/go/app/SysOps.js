...
export function DownloadLHM() {
  return window['go']['app']['SysOps']['DownloadLHM']();
}
...
export function GetLHMStatus() {
  return window['go']['app']['SysOps']['GetLHMStatus']();
}
...
export function StartLHM() {
  return window['go']['app']['SysOps']['StartLHM']();
}

export function StopLHM() {
  return window['go']['app']['SysOps']['StopLHM']();
}
